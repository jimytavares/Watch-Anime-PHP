    ...
    <section class="container-fluid" style="background-color:#eeebf9; width: 95%; margin-top: 0px; height:700px; border-radius:5px;">
        ...
        <div class="" style="background-color:white; width: 98%; margin-top: 20px; margin-left:10px; border-radius:3px;">
            ...
            <div class="row no-gutters">
                <div class="col">
                    <h4 style="margin-left: 50px; padding-top:20px; font-family: 'Poppins', sans-serif; margin-left:20%;"> <i class="fas fa-angle-double-right" style="font-size:20px;"></i> <b>Ranking</b> Animes</h4>
                </div>
                <div class="col-md-auto">
                </div>
                <div class="col-md-auto">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="comentario" class="form-control" id="exampleFormControlInput1" placeholder="data que saiu o anime" style="width:20%; background-color:transparent; color:red; border-radius:3px; border: 1px solid #999999; margin-left:40px;">
                        </div>
                      </div>
                  </div> 
