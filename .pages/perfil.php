...
<body style="background-image: linear-gradient(to right, #6424ea,  #ad00b1, #9200c5);">
    ...
    <sectcion>
        <div class="container-fluid" style="width: 95%; margin-top:30px;">
            ...
            <div class="row" style="margin-left:40px;">
                <div class="col-md-auto">
                    <button type="button" class="btn btn-outline-success" style="background-color:black; opacity:0.6; width:100px; height: 50px; color:white; border-radius:1px;"> Home </button>
                </div>
                <div class="col-md-auto">
                    <button type="button" class="btn btn-outline-success" style="background-color:#eeebf9; width:100px; height: 50px; color:black; border-radius:1px; margin-left:-25px;"> <img src="../../trunk/imagens/icon-perfil3.png" style="width:90px; margin-left:-6px;"/> </button>
                </div>
                <div class="col-md-auto">
    ...
    <section class="container-fluid" style="background-color:#eeebf9;width: 95%; margin-top: 0px; height:1000px; border-radius:5px;">
        ...
        <!--#### ROW GERAL 01: Perfil ####-->
        <div class="" style="background-color:white; width: 99%; margin-left:5px; margin-top:70px; border-radius:5px; height:230px;">
            
            <!-- LINHA 01: Usuario, level, etc -->
            <div class="row" style="width:97%; margin-left:20px; padding-top:20px;">
                <div class="col-md-auto">
                    <img src="../../trunk/imagens/foto-perfil.jpg" />
                    
                </div>
                <div class="col-md-auto">
                    <h3> <i class="fas fa-street-view" style="color:#00b359;"></i> Nome Usuario</h3>
                    <p> <i class="fab fa-accusoft"></i> <b>Animes</b> Assistindo: 100</p>
                </div>
                <div class="col-md-auto">
                    <p style="margin-top:56px;"> <i class="fab fa-accusoft"></i> <b>Animes</b> Assistindo: 100</p>
                </div>
                <div class="col-md-auto" style="text-align:right;">
                    <h3>Level: 100</h3>
                    <p style=""> <i class="fab fa-accusoft"></i> <b>Animes</b> Assistindo: 100</p>
                </div>
