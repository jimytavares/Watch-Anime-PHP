    ...
    <section class="container-fluid" style="background-color:#eeebf9; width: 95%; margin-top: 5px; height:700px; border-radius:5px;">
        ...
        <div class="" style="background-color:white; width: 98%; margin-top: 20px; margin-left:10px; border-radius:3px;">
            ...
            <div class="" style="margin-left:3%; width: 1000px; margin-top:30px; border: ;">
                <form action="../control/insertParados.php" method="post" autocomplete="on" style="font-family: 'Poppins', sans-serif;">
                  ...
                  <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="episodio" class="form-control" id="exampleFormControlInput1" placeholder="" style="width:10%; background-color:transparent; color:red; border-radius:3px; border: 1px solid #999999; margin-left:50px;">
                        </div>
                      </div>
                  </div>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="nota" class="form-control" id="exampleFormControlInput1" placeholder="" style="width:10%; background-color:transparent; color:red; border-radius:3px; border: 1px solid #999999; margin-left:74px;">
                        </div>
                      </div>
                  </div> 
                  <div class="form-group">
